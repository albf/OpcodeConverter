...
echo ~/ellcc/bin/ecc -target mips-linux-eng -S src/${1}.c -I ../MipsCTestCases/extras/lib/ -O2 -nostdlib -fno-exceptions -fno-rtti -static -o bin2/${1}.s

~/ellcc/bin/ecc -target mips-linux-eng -S src/${1}.c -I ../MipsCTestCases/extras/lib/ -O2 -nostdlib -fno-exceptions -fno-rtti -static -o bin2/${1}.s
