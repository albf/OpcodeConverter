...
struct pointer arrayxor[T_SIZE] = {  { &&xorPLUSsll, NULL }  ,  { &&xorPLUSerror, NULL }  ,  { &&xorPLUSsrl, NULL }  ,  { &&xor, NULL }  ,  { &&xor, NULL }  ,  { &&xorPLUSerror, NULL }  ,  { &&xor, NULL }  ,  { &&xor, NULL }  ,  { &&xor, NULL }  ,  { &&xor, NULL } 
 ...
 ,  { &&xor, NULL }  ,  { &&xor, NULL }  ,  { &&xor, NULL }  ,  { &&xorPLUSslti, NULL }  ,  { &&xor, NULL }  ,  { &&xorPLUSandi, NULL }  ,  { &&xor, NULL }  ,  { &&xor, NULL }  ,  { &&xor, NULL }  ,  { &&xorPLUSerror, NULL } 
...
struct pointer arraylw[T_SIZE] = {  { &&lwPLUSsll, NULL }  ,  { &&lwPLUSerror, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL }  ,  { &&lwPLUSerror, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL }  ,  { &&lwPLUSjr, NULL }  ,  { &&lw, NULL } 
 ...
 ,  { &&lwPLUSerror, NULL }  ,  { &&lwPLUSerror, NULL }  ,  { &&lw, NULL }  ,  { &&lwPLUSaddu, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL } 
 ...
 ,  { &&lwPLUSbgtz, NULL }  ,  { &&lw, NULL }  ,  { &&lwPLUSaddiu, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL }  ,  { &&lwPLUSori, NULL }  ,  { &&lw, NULL }  ,  { &&lw, NULL }  ,  { &&lwPLUSerror, NULL } 
...
struct pointer arraysw[T_SIZE] = {  { &&swPLUSsll, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL } 
 ...
 ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&sw, NULL }  ,  { &&swPLUSjal, NULL }  ,  { &&sw, NULL }  ,  { &&swPLUSbne, NULL }  ,  { &&sw, NULL } 
...
VM_memory[RF[rs] + immediate + 1] = (uint8_t)((RF[rt] & 0xFF0000) >> 16);
PC  =  nPC;
nPC  += 4;  instr0 = (((uint32_t)VM_memory[PC] <<24) | ((uint32_t)VM_memory[PC+1] <<16) | ((uint32_t)VM_memory[PC+2] <<8) | ((uint32_t)VM_memory[PC+3]));
  op0 = (instr0 >> 26) & 0x3F;
  if (op0 == 0x0) {
    funct = (instr0 >> 0) & 0x3F;
    op0 = op0 + funct;
